...
import ReferralComponent from '../components/referral_component'
          ...
          <div  className='flex flex-col items-center md:py-10 py-8 ' >
            <div className="flex justify-between  w-11/12 md:w-9/12 px-2 md:px-10 md:mb-10 mb-8">
                  <div className='flex flex-col gap-2 md:mt-10 basis-1/2'>
                      ...
                      <p className='text-slate-800 text-xs md:text-lg font-bungee underline underline-offset-4'>by <a className='font-semibold italic' href="#">Hemp City</a></p>
